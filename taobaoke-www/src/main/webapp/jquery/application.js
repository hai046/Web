(function($)
{
    ...
    {
    	function itemClick(){
    		$("#dis_title").html( $(this).children("[name='title']").val() );
    	...
    	function createItemAndAppend2List(data){
    		...
    		innerHtml = innerHtml + '<a href="#nogo" class="title">' + data.title + '</a>';
    		innerHtml = innerHtml + '<p class="sale">¥' + data.price + '</p>';
    		innerHtml = innerHtml + '<p class="num">销量：' + data.volume + '</p>';
